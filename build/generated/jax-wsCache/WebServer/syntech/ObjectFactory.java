...
public class ObjectFactory {
    ...
    private final static QName _DeleteResponse_QNAME = new QName("http://syntech/", "deleteResponse");
    private final static QName _HelloResponse_QNAME = new QName("http://syntech/", "helloResponse");
    private final static QName _Delete_QNAME = new QName("http://syntech/", "delete");
    private final static QName _InsertResponse_QNAME = new QName("http://syntech/", "insertResponse");
    private final static QName _UpdateResponse_QNAME = new QName("http://syntech/", "updateResponse");
    private final static QName _Insert_QNAME = new QName("http://syntech/", "insert");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://syntech/", name = "deleteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://syntech/", name = "delete")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://syntech/", name = "insertResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://syntech/", name = "insert")
